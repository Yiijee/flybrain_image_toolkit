...
path_to_template='./templates/gfpCtrl_PNs488_MB334C_568_ChAT_647_Slide1_Animal4_Left_ch3.nrrd' # template
path_to_macro='./macro' #path to macro folder
output_folder='./Emma/warp_output' # output folder, will create one if needed 
