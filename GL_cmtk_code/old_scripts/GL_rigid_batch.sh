...
path_to_tifs='./Yijie/KC_manipulation' #the folder for tif images need to be registered 
path_to_template='./templates/rigid_YP-25-025_attp2_1_ch4_rotate.nrrd' # template
path_to_macro='./macro' #path to macro folder
output_folder='./Yijie/output' # output folder, will create one if needed 
reference_channel=4 # reference channel for registration
reformat_channels=(1) # channels to reformat
